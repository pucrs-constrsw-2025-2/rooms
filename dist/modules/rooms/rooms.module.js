...
const furnitures_module_1 = require("./furnitures/furnitures.module");
...
exports.RoomsModule = RoomsModule = __decorate([
    (0, common_1.Module)({
        imports: [furnitures_module_1.FurnituresModule],
        controllers: [rooms_controller_1.RoomsController],
        providers: [rooms_service_1.RoomsService, prisma_room_repository_1.PrismaRoomRepository, prisma_service_1.PrismaService, jwt_auth_guard_1.JwtAuthGuard],
